...
<body>
    ...
    <div class="main">
        ...
        <a href="viewcase.php">VIEW USER</a>
    ...
    <!------------------------------------------------------------->
    <div class="detail">
        <h2>Lawyer Request</h2> <br>

            <div class="Approve">
                <form action="Case.php" method="POST">
                    <label for="">Enter Case ID</label>
                    <input type="text" name="CID" id="" placeholder="Enter Case ID to Accept">
        ...
        <?php
            ...
            $ret = mysqli_query($conn,"SELECT * FROM user_portal");
